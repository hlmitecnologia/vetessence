...
class PaymentGatewayTest extends TestCase
{
    ...
    {
        $ids = [];
        $ids[] = PaymentGateway::create(['name' => 'A', 'provider' => 'a', 'channel' => 'portal', 'is_active' => true])->id;
        $ids[] = PaymentGateway::create(['name' => 'B', 'provider' => 'b', 'channel' => 'portal', 'is_active' => false])->id;
