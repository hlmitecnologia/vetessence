...
2. Você vê todas as faturas geradas para você
3. Filtre por **status**: Pendentes, Pagas, Vencidas, Canceladas
...
| **Cancelada** | Fatura cancelada/estornada |

## Detalhes da Fatura

Ao abrir uma fatura, você confere:
- **Número** da fatura
- **Data de emissão**
- **Data de vencimento**
