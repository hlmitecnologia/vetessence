...
```
293 Unit + 385 Feature = 678 testes (0 falhas)
```
...
Este README é gerado a partir do [PLAN.md](./PLAN.md). A cada push no git, execute:

```bash
cp PLAN.md README.md
```

para manter o plano de construção e o status dos testes sincronizados com o README. **Mantenha o idioma em português brasileiro.**
