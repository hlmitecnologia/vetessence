...
<div class="auth-container">
    <div class="w-full max-w-md portal-card p-8 sm:p-10">
        <div class="text-center mb-8">
            ...
            @endif
            <p class="text-lg text-gray-500 mt-2">Portal do Tutor — Crie sua conta</p>
        </div>
        ...
        <form method="POST" action="{{ route('portal.register.store') }}">
            ...
            <div class="mb-5">
                <label class="portal-label">Telefone</label>
                <div class="relative">
                    <i class="fas fa-phone absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg"></i>
            ...
            <div class="mb-8">
                <label class="portal-label">Confirmar senha</label>
                <div class="relative">
                    <i class="fas fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg"></i>
