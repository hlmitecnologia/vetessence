        ...
        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="provider" class="form-control provider-select @error('provider') is-invalid @enderror" data-group="gateway" required>
                            ...
                            <option value="multicard" {{ old('provider') == 'multicard' ? 'selected' : '' }}>MultiplusCard (PinPDV)</option>
                            <option value="payer" {{ old('provider') == 'payer' ? 'selected' : '' }}>Payer API Gateway</option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="channel" class="form-control @error('channel') is-invalid @enderror" required>
                            ...
                            <option value="pdv" {{ old('channel') == 'pdv' ? 'selected' : '' }}>PDV (pagamento presencial na maquininha)</option>
                            <option value="both" {{ old('channel') == 'both' ? 'selected' : '' }}>Ambos (Portal + PDV)</option>
                        </select>
            ...
            <div class="provider-fields" data-provider="mercadopago" data-group="gateway" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="config[terminal_id]" class="form-control @error('config.terminal_id') is-invalid @enderror" value="{{ old('config.terminal_id') }}" placeholder="Ex: NEWLAND_N950__N950NCB801293324">
                ...
                <div class="alert alert-warning mb-0">
                    ...
                    <div class="input-group mt-2">
                        <input type="text" readonly class="form-control" value="Salve o gateway primeiro para gerar a URL" id="mp-webhook-preview">
                        <div class="input-group-append">
            ...
            {{-- PAYER --}}
            <div class="provider-fields" data-provider="payer" data-group="gateway">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="config[company_id]" class="form-control @error('config.company_id') is-invalid @enderror" value="{{ old('config.company_id') }}" placeholder="ID da empresa na Payer">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="config[store_id]" class="form-control @error('config.store_id') is-invalid @enderror" value="{{ old('config.store_id') }}" placeholder="ID da loja na Payer">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="config[terminal_id]" class="form-control @error('config.terminal_id') is-invalid @enderror" value="{{ old('config.terminal_id') }}" placeholder="ID do terminal Payer">
                            @error('config.terminal_id')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="config[automation_name]" class="form-control @error('config.automation_name') is-invalid @enderror" value="{{ old('config.automation_name') }}" placeholder="Nome da automação">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="config[client_id]" class="form-control @error('config.client_id') is-invalid @enderror" value="{{ old('config.client_id') }}" placeholder="clientId da API Payer">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="config[username]" class="form-control @error('config.username') is-invalid @enderror" value="{{ old('config.username') }}" placeholder="userName (e-mail)">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="config[user_alias]" class="form-control @error('config.user_alias') is-invalid @enderror" value="{{ old('config.user_alias') }}" placeholder="userAlias">
                ...
                <div class="alert alert-warning mb-0">
                    ...
                    <div class="input-group mt-2">
                        <input type="text" readonly class="form-control" value="Salve o gateway primeiro para gerar a URL" id="payer-webhook-preview">
                        <div class="input-group-append">
            ...
            <div class="provider-fields" data-provider="multicard" data-group="gateway" style="display:none;">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="password" name="secret_key" class="form-control @error('secret_key') is-invalid @enderror" value="{{ old('secret_key') }}" placeholder="Bearer token de longa duração">
                            @error('secret_key')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="config[ambiente]" class="form-control @error('config.ambiente') is-invalid @enderror" required>
                                <option value="">Selecione</option>
                                <option value="homologacao" {{ old('config.ambiente') == 'homologacao' ? 'selected' : '' }}>Homologação</option>
                                <option value="producao" {{ old('config.ambiente') == 'producao' ? 'selected' : '' }}>Produção</option>
                            </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="config[pinpdv_id]" class="form-control @error('config.pinpdv_id') is-invalid @enderror" value="{{ old('config.pinpdv_id') }}" placeholder="ID numérico do SmartPOS (obtido via portal ou GET /pinpdv)">
