    ...
    <form wire:submit.prevent="save">
        ...
        <div class="form-group">
            <div class="custom-control custom-switch">
                <input type="checkbox" wire:model="is_active" class="custom-control-input" id="consentTemplateIsActive">
                <label class="custom-control-label" for="consentTemplateIsActive">Ativo</label>
            </div>
        </div>
