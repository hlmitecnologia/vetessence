<div>
    <form wire:submit.prevent="save">
        ...
        <div class="form-group">
            ...
            <textarea wire:model="medications" class="wysiwyg form-control @error('medications') is-invalid @enderror" rows="2" maxlength="500"></textarea>
            @error('medications') <span class="invalid-feedback">{{ $message }}</span> @enderror
        </div>
