@extends('layouts.adminlte', ['title' => 'Editar Modelo de Termo'])
...
<div class="card">
    ...
    <form action="{{ route('consent-templates.update', $template) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row">
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" rows="12" class="form-control @error('content') is-invalid @enderror" required>{{ old('content', $template->content) }}</textarea>
