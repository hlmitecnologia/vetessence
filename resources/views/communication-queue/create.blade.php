    ...
    <form action="{{ route('communication-queue.store') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="message_content" id="message_content" rows="5" class="form-control @error('message_content') is-invalid @enderror" required>{{ old('message_content') }}</textarea>
