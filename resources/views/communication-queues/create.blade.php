    ...
    <form action="{{ route('communication-queues.store') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="message_content" id="message_content" rows="4" class="wysiwyg form-control @error('message_content') is-invalid @enderror">{{ old('message_content') }}</textarea>
