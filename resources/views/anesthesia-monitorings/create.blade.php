            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="anesthetic_protocol" id="anesthetic_protocol" rows="2" class="wysiwyg form-control @error('anesthetic_protocol') is-invalid @enderror">{{ old('anesthetic_protocol') }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="premedication" id="premedication" rows="2" class="wysiwyg form-control @error('premedication') is-invalid @enderror">{{ old('premedication') }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="observations" id="observations" rows="2" class="wysiwyg form-control @error('observations') is-invalid @enderror">{{ old('observations') }}</textarea>
