    ...
    <form action="{{ route('branches.update', $branch) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="number" class="form-control" value="{{ old('number', $branch->number) }}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="neighborhood">Bairro</label>
                        <input type="text" name="neighborhood" class="form-control" value="{{ old('neighborhood', $branch->neighborhood) }}">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label for="complement">Complemento</label>
                <input type="text" name="complement" class="form-control" value="{{ old('complement', $branch->complement) }}">
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="zip_code">CEP</label>
                        <input type="text" name="zip_code" class="form-control" value="{{ old('zip_code', $branch->zip_code) }}" maxlength="10" placeholder="00000-000">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="ie" class="form-control @error('ie') is-invalid @enderror" value="{{ old('ie', $branch->ie) }}" required>
            ...
            <div class="form-group mt-3">
                ...
                <textarea name="notes" rows="2" class="wysiwyg form-control @error('notes') is-invalid @enderror">{{ old('notes', $branch->notes) }}</textarea>
...
$(function() {
    $('#branch_state_id').on('change', function() {
        ...
        if (stateId) {
            $.get('/api/cities/' + stateId, function(data) {
                ...
                @if(old('city_id', $branch->city_id))
                    $citySelect.val('{{ old('city_id', $branch->city_id) }}');
                @endif
            });
        } else {
    ...
    @if(old('state_id', $branch->state_id))
