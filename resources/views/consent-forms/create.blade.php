            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="consent_template_id" id="consent_template_id" class="form-control @error('consent_template_id') is-invalid @enderror">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="witness_id" id="witness_id" class="form-control @error('witness_id') is-invalid @enderror">
                            <option value="">Selecione</option>
